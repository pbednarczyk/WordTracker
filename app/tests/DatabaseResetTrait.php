...
trait DatabaseResetTrait
{
    private function resetDatabase(): void
    {
        ...
        $connection->executeStatement(
            'TRUNCATE TABLE learning_review, learning_card, publication_vocabulary_enrichment, publication_vocabulary, vocabulary_occurrence, vocabulary_item, publication RESTART IDENTITY CASCADE',
        );
    }
